 ...
 * Copied verbatim from design/image-slot.js — served as a static asset from public/.
 * The `window.omelette` write-back is a no-op in production (slot becomes read-only).
 * To show a static image, set the `src` attribute on the element.
 */
(() => {
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.addEventListener('click', (e) => {
        ...
        if (act === 'clear') {
          this._exitReframe(false); this._gen++;
          this._local = null;
